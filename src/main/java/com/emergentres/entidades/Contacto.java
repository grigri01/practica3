 ...
 */
package com.emergentres.entidades;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Contacto.findByTelefono", query = "SELECT c FROM Contac                                                                                                                                         to c WHERE c.telefono = :telefono")})
public class Contacto implements Serializable {
    ...
    public String toString() {
        return "com.emergentres.entidades.Contacto[ id=" + id + " ]";
    }
